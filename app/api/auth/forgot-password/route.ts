...
export async function POST(request: Request) {
  ...
  const html = [
    ...
    `<p style=\"font-family:Geist Mono,SFMono-Regular,Menlo,Consolas,monospace;font-size:20px;font-weight:700;letter-spacing:0.04em;color:#071B33;\">${tempPassword}</p>`,
